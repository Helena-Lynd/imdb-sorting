...
public class MovieComparatorRuntime implements Comparator<Movie> {
     ...
     * @return less than 0 if m2 has less runtime than m1
     *                     if runtimes are equal it is the natural order comparison of m1 to m2's titles
     *         greater than 0 if m2's runtime is greater than m1's.
     */
    @Override
